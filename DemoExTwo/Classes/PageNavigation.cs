...
namespace DemoExTwo
{
    class PageNavigation : INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;
        static int countitems = 4; //количество объектов для отображения
        ...
        public int CountPage  //количество на странице
        {
            ...
            set
            {
                ...
                if (Countlist % value == 0) 
                   ...
                   CountPages = 1 + Countlist / value;//если получается не целое еоличество страниц
            }
        }
